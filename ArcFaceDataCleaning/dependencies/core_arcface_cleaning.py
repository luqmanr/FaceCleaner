...
def preprocess(img, bbox=None, landmark=None, **kwargs):
    ...
    if landmark is not None:
        ...
        # if not os.path.exists('./dataset/pre-warped1.jpg'):
        #     cv2.imwrite('./dataset/pre-warped1.jpg', img)
        # else:
        #     cv2.imwrite('./dataset/pre-warped2.jpg', img)

        warped = cv2.warpAffine(img,M,(image_size[1],image_size[0]), borderValue = 0.0)

        # if not os.path.exists('./dataset/warped1.jpg'):
        #     cv2.imwrite('./dataset/warped1.jpg', warped)
        # else:
        #     cv2.imwrite('./dataset/warped2.jpg', warped)
